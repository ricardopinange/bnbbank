<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_new_check"
    ref="newCheckModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          >
            ...
            <div class="mb-13 text-center">
              <!--begin::Title-->
              <h1 class="mb-3">Set First Target 5555555</h1>
              <!--end::Title-->
            ...
            <div class="d-flex flex-column mb-8">
              ...
              <el-form-item prop="targetDetails">
                <el-input
                  v-model="formData.targetDetails"
                  type="textarea"
                  rows="3"
                  name="targetDetails"
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newCheckModalRef.value);
            });
          }, 2000);
        } else {
          Swal.fire({
