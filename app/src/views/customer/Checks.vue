      ...
      <div class="card-toolbar m-0">
        ...
        >
          <li class="nav-item" role="presentation">
            <a
              id="kt_situation_pending_tab"
              class="nav-link justify-content-center text-active-gray-800 active"
              data-bs-toggle="tab"
              role="tab"
              href="#kt_situation_pending"
              @click="changeSituation('Pending')"
            >
              Pending
            </a>
          </li>
          <li class="nav-item" role="presentation">
            <a
              id="kt_situation_accepted_tab"
              class="nav-link justify-content-center text-active-gray-800"
              data-bs-toggle="tab"
              role="tab"
              href="#kt_situation_accepted"
              @click="changeSituation('Accepted')"
            >
              Accepted
            </a>
          </li>
          <li class="nav-item" role="presentation">
            <a
              id="kt_situation_rejected_tab"
              class="nav-link justify-content-center text-active-gray-800"
              data-bs-toggle="tab"
              role="tab"
              href="#kt_situation_rejected"
              @click="changeSituation('Rejected')"
            >
              Rejected
            </a>
          </li>
